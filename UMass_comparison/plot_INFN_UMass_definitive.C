...
void plot_INFN_UMass_definitive(){
	...
	g_INFN_amp30->Draw("PZ");
	g_UMass_amp30->Draw("PZ");


	new TCanvas();
	g_all_ampexp->Draw("APZ");
	g_INFN_ampexp->Draw("PZ");
	g_UMass_ampexp->Draw("PZ");


	new TCanvas();
	g_all_ampintegral->Draw("APZ");
	g_INFN_ampintegral->Draw("PZ");
	g_UMass_ampintegral->Draw("PZ");
	...
	g_INFN_amp30_normalized->Draw("PZ");
	g_UMass_amp30_normalized->Draw("PZ");
	f_quadratic->SetParameters(1,0.005);
	//g_all_amp30_normalized->Fit(f_quadratic);
	...
	new TCanvas();
	g_all_ampintegral_normalized->Draw("APZ");
	g_INFN_ampintegral_normalized->Draw("PZ");
	g_UMass_ampintegral_normalized->Draw("PZ");
	f_quadratic->SetParameters(1,0.005);
	//g_all_ampintegral_normalized->Fit(f_quadratic);
