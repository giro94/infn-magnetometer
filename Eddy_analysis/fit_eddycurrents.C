...
void fit_eddycurrents(TString input_file, TString output_file=""){
	...
	kick1_zoom->GetYaxis()->SetRangeUser(-4*trace_offset,trace_offset);
	kick1_zoom_smooth->GetYaxis()->SetRangeUser(-4*trace_offset,trace_offset);
	kick1_zoom_rebin->GetYaxis()->SetRangeUser(-4*trace_offset,trace_offset);
	kick1_zoom_lowpass->GetYaxis()->SetRangeUser(-4*trace_offset,trace_offset);
	kick8_zoom->GetYaxis()->SetRangeUser(-4*trace_offset,trace_offset);
	kick8_zoom_smooth->GetYaxis()->SetRangeUser(-4*trace_offset,trace_offset);
	kick8_zoom_rebin->GetYaxis()->SetRangeUser(-4*trace_offset,trace_offset);
	kick8_zoom_lowpass->GetYaxis()->SetRangeUser(-4*trace_offset,trace_offset);
	...
	TH1F** h1_fft_kicks = new TH1F* [8];
	TH1F** h1_fft_kicks_smooth = new TH1F* [8];
	TH1F** h1_fft_kicks_rebin = new TH1F* [8];
	TH1F** h1_fft_kicks_lowpass = new TH1F* [8];
	...
	for (int i=0; i<8; i++){
		...
		TH1F* fftResidualInit = SetupFFT(kicks[i], fft_xmin, fft_xmax);
	...
	for (int i=0; i<8; i++){
		...
		TVirtualFFT::SetTransform(0);
		TH1F* fftResidualInit_smooth = SetupFFT(kicks_smooth[i], fft_xmin, fft_xmax);
	...
	for (int i=0; i<8; i++){
		...
		TVirtualFFT::SetTransform(0);
		TH1F* fftResidualInit_rebin = SetupFFT(kicks_rebin[i], fft_xmin, fft_xmax);
	...
	for (int i=0; i<8; i++){
		...
		TVirtualFFT::SetTransform(0);
		TH1F* fftResidualInit_lowpass = SetupFFT(kicks_lowpass[i], fft_xmin, fft_xmax);
