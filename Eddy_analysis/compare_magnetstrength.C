...
void compare_magnetstrength(){
	...
	//TFile* f1 = TFile::Open("fitted_kick_analysis_output_SD_R0_eddy_oct12_H20_nofilter_B0.root");
	TFile* f1 = TFile::Open("fitted_kick_analysis_output_SD_R0_eddy_oct13_H20_nofilter_B0.root");
	//TFile* f1 = TFile::Open("fitted_kick_analysis_output_SD_R0_eddy_oct14_H25_nofilter_B0.root");
	TFile* f2 = TFile::Open("fitted_kick_analysis_output_SD_R0_eddy_oct11_H20_nofilter_B3884.root");
	//TFile* f3 = TFile::Open("fitted_kick_analysis_output_SD_R0_eddy_oct12_H20_nofilter_B4595.root");
	TFile* f3 = TFile::Open("fitted_kick_analysis_output_SD_R0_eddy_oct13_H20_nofilter_B4595.root");
	TFile* f4 = TFile::Open("fitted_kick_analysis_output_SD_R0_eddy_oct10_H20_nofilter_Bfield.root");
	vector<double> strengths = {0, 3884, 4595, 5175};

	/*
	TFile* f1 = TFile::Open("fitted_kick_analysis_output_SD_R0_eddy_oct23_H25_B0_k777.root");
	TFile* f2 = TFile::Open("fitted_kick_analysis_output_SD_R0_eddy_oct20_H25_B50_k777.root");
	TFile* f3 = TFile::Open("fitted_kick_analysis_output_SD_R0_eddy_oct21_H25_B88_k777.root");
	TFile* f4 = TFile::Open("fitted_kick_analysis_output_SD_R0_eddy_oct21_H25_B100_k777.root");
	//TFile* f4 = TFile::Open("fitted_kick_analysis_output_SD_R0_eddy_oct22_H25_B100_k777.root");
	vector<double> strengths = {0, 3884, 4595, 5175};
	*/
	...
	leg1->AddEntry(f1_kick1_exp,Form("Magnet %.1f%%",strengths[0]),"L");
	leg1->AddEntry(f2_kick1_exp,Form("Magnet %.1f%%",strengths[1]),"L");
	leg1->AddEntry(f3_kick1_exp,Form("Magnet %.1f%%",strengths[2]),"L");
	leg1->AddEntry(f4_kick1_exp,Form("Magnet %.1f%%",strengths[3]),"L");
	leg1->Draw();
	can->cd(2);
