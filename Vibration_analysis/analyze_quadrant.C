...
void analyze_quadrant(TString folder, TString fileout="", TString outfolder=""){
	...
	TProfile* p_traceX = new TProfile("p_traceX","",Nlines,tstart,tend);
	TProfile* p_traceY = new TProfile("p_traceY","",Nlines,tstart,tend);
	TH1D* p_traceR = new TH1D("p_traceR","",Nlines,tstart,tend);
	TProfile* p_traceSum = new TProfile("p_traceSum","",Nlines,tstart,tend);
