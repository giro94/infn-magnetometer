{
	...
	ifstream f1("kicker_region_noRF_beamProfile.csv");
	ifstream f2("kicker_region_xRF_beamProfile.csv");
	ifstream f3("kicker_region_xyRF5_beamProfile.csv");
	ifstream f4("kicker_region_xyRF6_beamProfile.csv");

	TFile* fout = new TFile("beam_dists_eva.root","recreate");
